...
builder.Services.AddCors(options =>
{
    options.AddPolicy(name: "AllowOrigin",
        builder =>
        {
            builder.WithOrigins("http://localhost:62498", "http://localhost:4200")
                                .AllowAnyOrigin()
                                .AllowAnyHeader()
                                .AllowAnyMethod();
...
builder.Services.AddScoped<IClaimRegService, ClaimRegService>();
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        options.SwaggerDoc("v1", new OpenApiInfo { Title = "Medical-Claim", Version = "v1" });
